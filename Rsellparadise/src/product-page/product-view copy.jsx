...
function Product (){
    ...
    return(
        <section>
            ...
            <div>
                <h1 className=" text-2xl ml-4">resellparadise<i class="las la-tag tag-flip"></i></h1>
            </div>
            <div>
                <h1 className=" text-2xl text-right mr-4">cart<i class="las la-shopping-cart"></i></h1>
            </div>
            </div>
